  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:flche_bleue:988483591824621648>  **Name**', "```"+json.name+"```", true)
        .addField("<:flche_bleue:988483591824621648>  **Hex**",  "```"+json.hex+"```", true)
        .addField("<:flche_bleue:988483591824621648>  **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<:flche_bleue:988483591824621648>  **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
