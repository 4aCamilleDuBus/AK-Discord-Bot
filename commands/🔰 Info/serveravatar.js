...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      .addField("<:flche_bleue:985990518649532437>  PNG",`[\`LINK\`](${message.guild.iconURL({format: "png"})})`, true)
      .addField("<:flche_bleue:985990518649532437>  JPEG",`[\`LINK\`](${message.guild.iconURL({format: "jpg"})})`, true)
      .addField("<:flche_bleue:985990518649532437>  WEBP",`[\`LINK\`](${message.guild.iconURL({format: "webp"})})`, true)
