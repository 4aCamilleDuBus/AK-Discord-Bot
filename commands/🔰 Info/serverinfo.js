  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      .setAuthor(client.la[ls].cmds.info.serverinfo.author + " " +  message.guild.name, message.guild.iconURL({
        dynamic: true
      }), "https://discord.com/api/oauth2/authorize?client_id=985894969116069928&permissions=8&scope=bot%20applications.commands")
      ...
      embed.addField(client.la[ls].cmds.info.serverinfo.field13, `<:nitro:985145464192110632>  \`${boostlevel}\``, true)
