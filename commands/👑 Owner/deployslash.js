    ...
    if (message.author.id != "973907165486133248")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only CamilleDuBus is allowed to deploy the Slash-Commands")
          .setDescription(`Go DM 4a | CamiDuBus#9245 and ask him for activate slash commands on your server !`)
        ]
      });
    try {
