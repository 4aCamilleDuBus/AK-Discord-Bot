  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    let color = options.getString("color");
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:flche_bleue:985990518649532437>  **Name**', json.name, true)
        .addField("<:flche_bleue:985990518649532437>  **Hex**", json.hex, true)
        .addField("<:flche_bleue:985990518649532437>  **RGB**", json.rgb, true)
        .addField(`<:flche_bleue:985990518649532437>  **${client.la[ls].cmds.info.color.brightershade}**`, json.brightened, true)
