    ...
    try{
		...
		try {   
		  ...
		  try{
			...
			embeduserinfo.setAuthor(handlemsg(client.la[ls].cmds.info.userinfo.author, { usertag: member.user.tag}), member.user.displayAvatarURL({ dynamic: true }), "https://discord.gg/lingolsheim")
			...
			embeduserinfo.setAuthor(handlemsg(client.la[ls].cmds.info.userinfo.author, { usertag: user.tag}), user.displayAvatarURL({ dynamic: true }), "https://discord.gg/lingolsheim")
...
/**
  ...
  * @INFO
  * Work for lingolsheim Development | https://lingolsheim.eu
  * @INFO
  * Please mention Him / lingolsheim Development, when using this Code!
  * @INFO
*/
